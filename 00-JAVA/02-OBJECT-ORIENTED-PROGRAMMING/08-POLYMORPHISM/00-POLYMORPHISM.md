...
---
![Developer](./images/polymorphism.drawio.svg)
##### Developer.java
```java
...
#### Memory Visual
![](./images/polymorphismMemoryMap.drawio.svg)**Now the question is — if I use a parent type reference (Developer dev), can I still call the child class overridden methods?**  
