...
![Invalid State](./images/invalidState.drawio.svg)
![Memory: Invalid State](./images/invalidStateMemory.drawio.svg)
...
```
![Valid State](./images/constructorValidStateMemory.drawio.svg)
...
![Object-Creation](./images/createAnObject.drawio.svg)
