...
![Aggragation & Composition](./images/hasARelationaship.drawio.svg)
### 1. Aggregation
...
```
![Aggregation](./images/AggregationCompositionMemoryBlock.drawio.svg)
...
![](./images/compositionMemoryBlock.drawio.svg)
...
```
![](./images/compositionMemoryBlockNull.drawio.svg)
